...
TYPE t_st_uart IS (st_idle, st_load, st_start_b, st_bit_0, st_bit_1, st_bit_2, st_bit_3, st_bit_4, st_bit_5, st_bit_6, st_bit_7, st_stop_b); 
...
begin
----------------------------------------------------
PROCESS (pres_st, TX_START, start_flag) BEGIN 
    ...
    WHEN st_load       => next_st <= st_start_b; 
...
PROCESS (pres_st, data_reg) BEGIN  
    ...
    CASE pres_st IS  
        ...
        WHEN st_load     => uart_txd_c <= '1'; busy_c <= '1';
