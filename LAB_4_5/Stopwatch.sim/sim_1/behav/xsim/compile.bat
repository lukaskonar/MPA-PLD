...
REM
REM Generated by Vivado on Fri Mar 13 11:53:44 +0100 2026
...
echo "xvhdl --incr --relax -prj bcd_counter_tb_vhdl.prj"
call xvhdl  --incr --relax -prj bcd_counter_tb_vhdl.prj -log xvhdl.log
