...
set_property PACKAGE_PIN P15 [get_ports {BTN[1]}]
set_property PACKAGE_PIN U13 [get_ports {BTN[2]}]
set_property PACKAGE_PIN T10 [get_ports {BTN[3]}]
set_property PACKAGE_PIN T11 [get_ports {BTN[4]}]
...
set_property PACKAGE_PIN C20 [get_ports {SW[3]}]
set_property PACKAGE_PIN B19 [get_ports {SW[4]}]
